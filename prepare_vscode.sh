...
setpath "product" "licenseUrl" "https://github.com/bradford-tech/code/blob/master/LICENSE"
setpath_json "product" "linkProtectionTrustedDomains" '["https://open-vsx.org"]'
setpath "product" "releaseNotesUrl" "https://go.microsoft.com/fwlink/?LinkID=533483#vscode"
setpath "product" "reportIssueUrl" "https://github.com/bradford-tech/code/issues/new"
setpath "product" "requestFeatureUrl" "https://github.com/bradford-tech/code/issues/new"
...
if [[ "${DISABLE_UPDATE}" != "yes" ]]; then
  ...
  if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
    ...
    setpath "product" "downloadUrl" "https://github.com/bradford-tech/code/releases"
  fi
...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "BradfordCode - Insiders"
  setpath "product" "nameLong" "BradfordCode - Insiders"
  setpath "product" "applicationName" "code-insiders"
  setpath "product" "dataFolderName" ".bradfordcode-insiders"
  setpath "product" "linuxIconName" "bradfordcode-insiders"
  ...
  setpath "product" "win32MutexName" "bradfordcodeinsiders"
  setpath "product" "win32NameVersion" "BradfordCode Insiders"
  setpath "product" "win32RegValueName" "BradfordCodeInsiders"
  setpath "product" "win32ShellNameShort" "BradfordCode Insiders"
  ...
  setpath "product" "tunnelApplicationName" "code-insiders-tunnel"
  setpath "product" "win32TunnelServiceMutex" "bradfordcodeinsiders-tunnelservice"
  setpath "product" "win32TunnelMutex" "bradfordcodeinsiders-tunnel"
  ...
  setpath "product" "nameShort" "BradfordCode"
  setpath "product" "nameLong" "BradfordCode"
  setpath "product" "applicationName" "code"
  setpath "product" "dataFolderName" ".bradfordcode"
  setpath "product" "linuxIconName" "bradfordcode"
  ...
  setpath "product" "win32MutexName" "bradfordcode"
  setpath "product" "win32NameVersion" "BradfordCode"
  setpath "product" "win32RegValueName" "BradfordCode"
  setpath "product" "win32ShellNameShort" "BradfordCode"
  ...
  setpath "product" "tunnelApplicationName" "code-tunnel"
  setpath "product" "win32TunnelServiceMutex" "bradfordcode-tunnelservice"
  setpath "product" "win32TunnelMutex" "bradfordcode-tunnel"
...
replace 's|Microsoft Corporation|BradfordCode|' package.json

cp resources/server/manifest.json{,.bak}

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "resources/server/manifest" "name" "BradfordCode - Insiders"
  setpath "resources/server/manifest" "short_name" "BradfordCode - Insiders"
else
  setpath "resources/server/manifest" "name" "BradfordCode"
  setpath "resources/server/manifest" "short_name" "BradfordCode"
fi
...
replace 's|Microsoft Corporation|BradfordCode|' build/lib/electron.ts
replace 's|([0-9]) Microsoft|\1 BradfordCode|' build/lib/electron.ts
